...
<main class="auth-page">
  ...
  <section class="auth-card">
    ...
    {#if mode === 'login' && data.vippsLoginEnabled}<a class="vipps-login" href={`/auth/vipps?next=${encodeURIComponent(data.next)}`}><span>V</span>Logg inn med Vipps</a><div class="divider"><span>eller bruk e-post</span></div>{/if}
