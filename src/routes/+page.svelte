    ...
    <section class="landing-hero">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          ...
          {:else}
            <a class="primary-cta" href="/login?ny=1">Opprett konto <ArrowRight size={18}/></a>
          {/if}
          <a class="secondary-cta" href="/login">Jeg har allerede en konto</a>
        </div>
