<script lang="ts">
  ...
  import { ArrowRight, BadgeCheck, Clock3, EyeOff, HeartHandshake, LockKeyhole, PlusSquare, ShieldCheck, Sparkles, UserRound, X } from '@lucide/svelte';
...
{#if !data.user}
  <main class="landing-page">
      ...
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          {#if data.vippsLoginEnabled}
            ...
            <a class="secondary-cta" href="/login">Bruk e-post i stedet</a>
          {:else}
            <a class="primary-cta" href="/login?ny=1">Opprett gratis med e-post <ArrowRight size={17}/></a>
            <span class="coming-soon"><span>V</span>Vipps kommer snart</span>
          {/if}
        </div>
        <small>Alpha · gratis å prøve · ingen betalingskort · du eier oppmerksomheten din</small>
      </div>
    ...
    <section class="product-tour" aria-labelledby="product-tour-title">
      <header><p class="eyebrow"><i></i>Et roligere produkt</p><h2 id="product-tour-title">Du velger menneskene.<br/>Samvio viser resten i rekkefølge.</h2></header>
      <div class="tour-grid">
        <article><div class="tour-window chronological"><span>09:42</span><strong>Siden sist</strong><i></i><i></i><i></i><small>Du er ajour</small></div><h3>En feed som tar slutt</h3><p>Når du har sett de nye innleggene, sier Samvio fra. Ingen endeløs strøm.</p></article>
        <article><div class="tour-window profile"><span class="tour-avatar">SA</span><strong>Silje Andersen <BadgeCheck size={14}/></strong><small>@silje</small><div>Følger</div><div>Følgere</div></div><h3>Mennesker du kjenner</h3><p>Finn og følg dem du selv velger. Popularitet bestemmer ikke hva du ser.</p></article>
        <article><div class="tour-window privacy"><ShieldCheck size={30}/><strong>Du bestemmer</strong><span>Følgere</span><span>Offentlig</span><small>Endre synlighet for hvert innlegg.</small></div><h3>Privat som utgangspunkt</h3><p>Del med følgerne dine, eller velg offentlig når et øyeblikk skal kunne deles videre.</p></article>
      </div>
    </section>
    ...
    <section class="alpha-trust" aria-labelledby="alpha-title">
      <div><p class="eyebrow"><i></i>Åpen alpha</p><h2 id="alpha-title">Smått, tydelig og under utvikling.</h2><p>Samvio er i alpha. Du kan opprette profil, følge mennesker og dele øyeblikk allerede nå. Vi åpner gradvis mens moderering, aldersvern og Vipps-innlogging ferdigstilles.</p><a href="/om">Les om Samvio <ArrowRight size={16}/></a></div>
      <ul>
        <li><BadgeCheck size={20}/><span><strong>Tydelig identitet</strong>Ingen anonyme massekontoer.</span></li>
        <li><ShieldCheck size={20}/><span><strong>Rapportering og moderering</strong>Grenser er en del av produktet, ikke et tillegg.</span></li>
        <li><EyeOff size={20}/><span><strong>Ingen skjult anbefalingsmotor</strong>Rekkefølgen er kronologisk og forståelig.</span></li>
      </ul>
    </section>
...
<style>
  ...
  .coming-soon{min-height:50px;padding:0 15px;display:inline-flex;align-items:center;gap:8px;color:#747a75;font-size:12px;font-weight:700}.coming-soon>span{width:24px;height:24px;display:grid;place-items:center;border-radius:50%;background:#f0ded1;color:#a4512d}
  .product-tour{width:min(1180px,calc(100% - 40px));margin:84px auto 0}.product-tour>header{display:flex;align-items:end;justify-content:space-between;gap:40px;margin-bottom:30px}.product-tour>header .eyebrow{margin-bottom:7px}.product-tour h2{max-width:620px;margin:0;font:600 40px/1.05 'Newsreader',serif;letter-spacing:-1px}.tour-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.tour-grid>article{padding:18px;border:1px solid #dfdbd2;border-radius:20px;background:#fff}.tour-grid h3{margin:18px 2px 6px;font-size:15px}.tour-grid>article>p{margin:0 2px 3px;color:#717871;font-size:12px;line-height:1.55}.tour-window{height:210px;padding:20px;border-radius:14px;background:#f1f5f2;color:#315d49}.chronological{display:grid;grid-template-columns:1fr auto;align-content:start;gap:12px}.chronological>span{font-size:10px;color:#858b86}.chronological>strong{font-size:12px}.chronological>i{grid-column:1/-1;height:28px;border-radius:8px;background:#fff;box-shadow:0 2px 8px #26382f0a}.chronological>small{grid-column:1/-1;text-align:center;color:#315d49;font-weight:700}.profile{display:grid;place-items:center;align-content:center;text-align:center}.tour-avatar{width:62px;height:62px;display:grid;place-items:center;border-radius:50%;background:#315d49;color:#fff;font-weight:800}.profile strong{display:flex;align-items:center;gap:4px;margin-top:10px;font-size:12px}.profile small{color:#7b827c}.profile div{display:inline-block;margin-top:12px;padding:6px 10px;border-radius:8px;background:#fff;font-size:10px}.privacy{display:grid;place-items:center;align-content:center;gap:8px;text-align:center}.privacy strong{font-size:13px}.privacy span{width:100%;padding:8px;border-radius:8px;background:#fff;font-size:10px}.privacy small{color:#7b827c}.alpha-trust{width:min(1180px,calc(100% - 40px));margin:0 auto 84px;padding:48px;display:grid;grid-template-columns:1fr 1fr;gap:70px;border-radius:24px;background:#20382c;color:#fff}.alpha-trust h2{margin:0;font:600 38px 'Newsreader',serif}.alpha-trust>div>p:not(.eyebrow){color:#cad5cf;font-size:13px;line-height:1.65}.alpha-trust .eyebrow{color:#bcd3c5}.alpha-trust>div>a{display:inline-flex;align-items:center;gap:7px;margin-top:8px;font-size:12px;font-weight:800}.alpha-trust ul{display:grid;gap:10px;margin:0;padding:0;list-style:none}.alpha-trust li{display:flex;gap:12px;padding:14px;border:1px solid #ffffff17;border-radius:12px;background:#ffffff0a;color:#d8b39b}.alpha-trust li span{display:grid;gap:3px;color:#becbc4;font-size:11px;line-height:1.45}.alpha-trust li strong{color:#fff;font-size:12px}
  ...
  @media(max-width:850px){.landing-hero{grid-template-columns:1fr;padding-top:48px;gap:52px}.hero-preview{width:min(560px,100%);margin:auto}.landing-values{grid-template-columns:1fr}.landing-values article{padding:19px 5px}.landing-values article+article{border-left:0;border-top:1px solid #ded9ce}.tour-grid{grid-template-columns:1fr 1fr}.tour-grid>article:last-child{grid-column:1/-1}.public-grid{grid-template-columns:repeat(2,1fr)}.alpha-trust{grid-template-columns:1fr;gap:30px}}
  @media(max-width:600px){.landing-nav{height:68px}.landing-nav>div>a:not(.nav-login){display:none}.landing-nav>div{gap:0}.landing-hero{width:min(100% - 28px,1180px);padding:34px 0 48px}.hero-copy h1{font-size:46px;letter-spacing:-2px}.hero-lead{font-size:15px}.hero-actions{align-items:stretch;flex-direction:column}.coming-soon{justify-content:center}.secondary-cta{text-align:center}.hero-preview{padding:14px;border-radius:19px}.preview-photo{height:210px}.landing-values,.product-tour,.public-preview,.alpha-trust,.landing-footer{width:min(100% - 28px,1180px)}.product-tour{margin-top:60px}.product-tour>header{display:block}.product-tour h2{font-size:32px}.tour-grid{grid-template-columns:1fr}.tour-grid>article:last-child{grid-column:auto}.public-preview{padding:60px 0}.public-preview h2{font-size:32px}.public-grid{grid-template-columns:1fr}.public-preview>header{align-items:start}.alpha-trust{margin-bottom:60px;padding:30px 22px}.alpha-trust h2{font-size:31px}.landing-footer{align-items:flex-start;flex-wrap:wrap}.landing-footer p{width:calc(100% - 80px);margin:7px 0}.landing-footer nav{width:100%;margin:0}.landing-page{padding-bottom:env(safe-area-inset-bottom)}}
